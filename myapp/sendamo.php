...
//АВТОРИЗАЦИЯ
$user=array(
  'USER_LOGIN'=>'magdychv@gmail.com', #Ваш логин (электронная почта)
  'USER_HASH'=>'c84a4f7575b18db0e2c349ab9d53a3c198729128' #Хэш для доступа к API (смотрите в профиле пользователя)
);
$subdomain='magdychv'; #Поддомен напирмер MYSHOP.amocrm.ru
